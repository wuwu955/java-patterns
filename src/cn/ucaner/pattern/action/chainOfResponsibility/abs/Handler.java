...
public abstract class Handler {
     ...
     */
    public final boolean handlerResquest(int handLeve) {

        boolean bReq = false;
        /**
         * 判断自己是否可以审核  - 可以审核的话  直接审核完毕
         */
        System.out.println("当前审核人员 "+getnName()+" 最大审批金额 "+getLevel()+"需要审核的钱 "+handLeve);
        if (getLevel() >= handLeve) {
            ...
            if (this.nextHandler != null) {
                 ...
                 * 向上一级请求
                 */
                bReq = nextHandler.handlerResquest(handLeve);
                /**
                 * 根据上级的答复做出回应
                 */
                if (bReq) {
